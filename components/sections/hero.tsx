  ...
  return (
    <section className="relative flex min-h-svh items-center overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 pt-20 lg:px-8">
        ...
        >
          Global Offshore &amp; Maritime Excellence
        </motion.h1>
        ...
        >
          {COMPANY.legalName} delivers world-class vessel management, chartering,
          and offshore logistics — trusted by industry leaders across three
          continents since 2010.
        </motion.p>
